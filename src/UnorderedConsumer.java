...
public class UnorderedConsumer implements CSProcess {
    ...
    public UnorderedConsumer(int id, Any2AnyChannel inputChannel, int totalItems,
    ...
    public void run() {
        ...
        if (print) System.out.println("Consumer[" + id + "]: Done");
    }
}